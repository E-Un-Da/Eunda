...
public class StudyService {
    ...
    public String inviteMember(Long id, HttpServletRequest req, StudyInviteRequestDto requestDto)
        ...
        String joinLink = String.format("http://eunda.shop:8080/api/studies/%s/join?token=%s", id, joinToken); // 초대링크 생성
    ...
    public String requestToJoinStudy(Long id, HttpServletRequest req) throws MessagingException {
        ...
        String applyLink = "http://eunda.shop:8080/api/studies/" + id + "/apply-study?token=" + requestToken; // 초대링크 생성
